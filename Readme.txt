...
Messaging software is a p2p messaging application written in Java using a Swing GUI and the TCP network protocol.
...
then to run the program run the command "java -cp . Message.Main". A few items will be printed to the console and the GUI should then draw itself. If you want to test the program, connect to localhost and send messages to yourself.
--------------------------------------------------------------------
GUI EXPLANATION
...
"-" This button will disconnect you from the current contact and remove the contact
